            ...
            `}>
                ...
                <div className="p-6 md:p-8 border-t border-white/10 bg-primary sticky bottom-0">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <p className="text-sm font-bold text-white">Isabelle V.</p>
                            <p className="text-xs text-white/50">Member since 2021</p>
                        </div>
                    </div>
                    <button className="flex w-full items-center justify-center gap-2 px-4 py-2 rounded-lg border border-white/20 text-white/80 hover:bg-white/10 hover:text-white transition-colors text-sm font-medium">
